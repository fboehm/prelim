...
We present a previously studied family of stochastic processes, which are known as *determinantal point processes*, for use as priors in Bayesian inference. We focus on their uses in two distinct scientific settings: 
